...
import 'package:graduation_project/controller/cart_controller.dart';
import 'package:graduation_project/core/constant/color.dart';
import 'package:graduation_project/views/widgets/cart/buttoncart.dart';
          ...
          children: [
            GetBuilder<CartController>(
                ...
                Container(
                    ...
                    : Container(child: Text("Coupon Code ${controller.couponname!}" , style: TextStyle(color: AppColor.primary , fontWeight: FontWeight.bold),))
            ),
            Container(
